...
public class DlgCekSEPKontrolBedaPoli extends widget.Dialog {

    private final sekuel Sequel = new sekuel();
    private final DlgRegistrasiSEPPertama form;

    public DlgCekSEPKontrolBedaPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        panelTengah.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "::[ Pendaftaran SEP Kontrol Beda Poli ]::", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Inter", 0, 24), new java.awt.Color(0, 131, 62))); // NOI18N
