...
public class DlgCekKunjunganPertamaSEP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 131, 62)), "SEP KUNJUNGAN PERTAMA", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Inter Semibold", 0, 36), new java.awt.Color(0, 131, 62))); // NOI18N
        ...
        jLabel28.setText("No. RM / No. Kartu BPJS / No. Rujukan : ");
    ...
    private void BtnClose2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnClose2ActionPerformed
        ...
        if (NoRMPasien.getText().isBlank()) {
            ...
            if (Sequel.cariExistsSmc(
                "select * from referensi_mobilejkn_bpjs where (norm = ? or nomorkartu = ?) and tanggalperiksa = current_date() and status != 'Batal'",
                NoRMPasien.getText(), NoRMPasien.getText()
            )) {
                JOptionPane.showMessageDialog(null, "Pasien telah mengambil antrian di MobileJKN. Silahkan masuk melalui menu \"Cek In MobileJKN\"..!!");
            } else if (Sequel.cariIntegerSmc("select count(*) from pasien where no_peserta = ?", NoRMPasien.getText()) == 1) {
